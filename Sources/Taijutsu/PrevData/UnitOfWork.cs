...
using IUnitOfWork = Taijutsu.PrevData.Internal.IUnitOfWork;

namespace Taijutsu.PrevData
{
    public class UnitOfWork : IUnitOfWork, IAdvancedUnitOfWork, Internal.INative, IDisposable
    {
        ...
        {
            return dataContext.Provider.MarkAsCreated(entityFactory());
        }
        ...
        public IMarkingStep Mark<TEntity>(TEntity entity, dynamic options = null) where TEntity : IDeletableEntity, IAggregateRoot
        {
        ...
        public virtual IQueryOfEntityByKey<TEntity> UniqueOf<TEntity>(object key, dynamic options = null)
